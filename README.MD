...
## Checkout the app by scanning the QR code using Expo Go android app: https://tinyurl.com/4n2h86m6
...
👉 **Tab Navigation**: Navigate between sections like Home, Search, Bookmark and Profile with ease using tab navigation.
...
```bash
git clone https://github.com/Nihar-Walawalkar/Aora.git
cd Aora
```
